...
class SnackbarHelper {
    ...
    private fun show(
        ...
        activity.runOnUiThread {
            var view = if (snackbarView == null) activity.findViewById(R.id.content) else snackbarView;
            messageSnackbar = view?.let { Snackbar.make(it, message, Snackbar.LENGTH_INDEFINITE) }
